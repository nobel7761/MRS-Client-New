...
const SouvenirEdit = () => {
  ...
  useEffect(() => {
    return () => {
      ...
      if (photoPreview && !souvenir?.photoUrl) {
        revokeImagePreview(photoPreview);
      }
    };
  }, [photoPreview, souvenir]);
  ...
  const adjustImageScale = (direction: "in" | "out") => {
    setImageScale((prev) => {
      if (direction === "in") {
        return Math.min(3, prev + 0.1);
      } else {
  ...
  const removePhoto = () => {
    ...
    setPhotoPreview(souvenir?.photoUrl || "");
    setValue("photo", null);
    setImagePosition({ x: 50, y: 50 });
    setImageScale(1);
  };
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      if (selectedPhoto) {
        await souvenirApi.updatePhoto(id, selectedPhoto);
      }

      toast.success("Souvenir সফলভাবে আপডেট করা হয়েছে!");
      ...
      const errorMessage =
        ...
        error?.message ||
        "আপডেট ব্যর্থ হয়েছে। দয়া করে আবার চেষ্টা করুন।";
      ...
      <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-2 text-sm sm:text-base">
            Update souvenir submission details
          </p>
        </div>
        <Button
          variant="outlined"
        ...
        <div className="rounded-[44px] border border-gray-200 bg-white p-4 shadow-[0_40px_120px_-70px_rgba(15,23,42,0.4)] sm:p-8 lg:p-12">
          <div className="border-b border-primary/20 bg-white/70 p-6 backdrop-blur sm:p-8">
            <h2 className="text-3xl font-semibold text-brandColorSecondary">
              Souvenir সম্পাদনা করুন
            </h2>
            <p className="mt-2 max-w-3xl text-sm text-brandColorSecondary/70">
              নিচের ফর্মটি সম্পাদনা করে Souvenir আপডেট করুন।
            </p>
          </div>
          ...
          >
            ...
            {selectedCategory ? (
              <div className="relative overflow-hidden rounded-3xl border border-primary/10 bg-white/95 p-6 shadow-xl shadow-primary/10 sm:p-8">
                ...
                {/* Photo Upload - Similar to ShronikaSubmission */}
                <div className="mt-6">
                  <label className="text-sm font-semibold text-slate-800">
                    আপনার ছবি{" "}
                    {selectedPhoto && "(নতুন ছবি নির্বাচন করা হয়েছে)"}
                  </label>
                  <div className="mt-2">
                    {!photoPreview ? (
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        {photoPreview && (
                          <div className="mt-6 p-3 sm:p-4 rounded-2xl bg-primary/5 border border-primary/20 shadow-md backdrop-blur-sm w-full max-w-md">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2">
                              ...
                              <span className="text-xs sm:text-sm font-semibold text-brandColorSecondary min-w-[50px] sm:min-w-[60px] text-center">
                                {Math.round(imageScale * 100)}%
                              </span>
                              <button
                                type="button"
                                onClick={() => adjustImageScale("in")}
                                className="p-1.5 sm:p-2 rounded-lg bg-white border border-primary/20 hover:bg-primary/10 transition"
                                title="জুম ইন"
                              >
                                <svg
                              ...
                              <div className="w-px h-6 sm:h-8 bg-primary/20 mx-1 sm:mx-2"></div>
                        ...
                        {selectedPhoto && (
                          <div className="mt-4 w-full max-w-md p-4 rounded-xl bg-primary/5 border border-primary/20 shadow-md">
                        ...
                        {!selectedPhoto && souvenir.photoUrl && (
                          <div className="mt-4 w-full max-w-md p-4 rounded-xl bg-blue-50 border border-blue-200 shadow-md">
                            <p className="text-sm text-blue-800">
                              বর্তমান ছবি দেখানো হচ্ছে। নতুন ছবি আপলোড করতে উপরে
                              ক্লিক করুন।
                            </p>
                          </div>
                        )}
        ...
        >
          ...
          >
            ...
            <p className="relative mt-3 text-sm text-brandColorSecondary/70">
              Souvenir সফলভাবে আপডেট করা হয়েছে।
            </p>
