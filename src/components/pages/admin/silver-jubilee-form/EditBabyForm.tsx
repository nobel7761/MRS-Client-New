...
const EditBabyForm = ({ formData, setFormData }: EditBabyFormProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Baby Information */}
      <div className="border-b pb-4">
        <h3 className="text-lg font-semibold mb-4">Baby Information</h3>
        ...
        <div className="mb-4">
          <TextField
            label="Baby Phone Number"
            value={formData.babyPhone || ""}
            onChange={(e) =>
              setFormData({
                ...formData,
